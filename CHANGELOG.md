...
### Changed
- Cleaned up repository by removing unnecessary documentation files
- Updated .npmignore to exclude development-only documentation
- Kept only essential docs: README.md, CHANGELOG.md, CONTRIBUTING.md, LICENSE

### Fixed
- Package now includes only necessary files for production use
